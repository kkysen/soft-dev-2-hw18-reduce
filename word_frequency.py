...
class WordFrequencies(object):
    ...
    def words_frequency(self, words):
        # type: (List[str]) -> int
        return sum(self.word_frequency(word) for word in words)
...
def test():
    ...
    print(word_frequencies.word_frequency("Dante"))
    print(word_frequencies.word_frequency("the") + word_frequencies.word_frequency("and"))
    print(word_frequencies.words_frequency(["and", "the"]))
